...
video_name="man9"
test_name="notoriousman9-1"
prompt="A man with a hat is talking on a beach near a sea with waves. The golden sun shines on the sea and the sky is orange with beautiful clouds."
